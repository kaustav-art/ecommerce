...
<html
  ...
  <head>
    ...
    <title>Demo: Fullscreen Timeline - Extended UI | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>vendor/libs/animate-on-scroll/animate-on-scroll.css" />
  ...
  <body>
                  ...
                  <ul class="timeline timeline-center mt-12">
                    <li class="timeline-item">
                      <span
                        ...
                        data-aos="zoom-in"
                        data-aos-delay="200">
                        <i class="icon-base ri ri-brush-line"></i>
                      </span>
                        ...
                        <div class="card-body">
                          ...
                          <div class="collapse" id="collapseExample">
                            <ul class="list-group list-group-flush mt-4">
                              ...
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span> This Years's Total Balance : $70000</span>
                                <i class="icon-base ri ri-share-line cursor-pointer icon-sm"></i>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="d-flex flex-sm-row flex-column">
                            ...
                            <div>
                              ...
                              <div class="d-flex justify-content-between align-items-center">
                                <div>
                                  <i class="icon-base ri ri-star-fill text-warning icon-sm"></i>
                                  <i class="icon-base ri ri-star-fill text-warning icon-sm"></i>
                                  <i class="icon-base ri ri-star-fill text-warning icon-sm"></i>
                                  <i class="icon-base ri ri-star-fill text-warning icon-sm"></i>
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                          <div class="d-flex align-items-center flex-wrap cursor-pointer gap-4">
                            <i class="icon-base ri ri-links-line icon-sm"></i>
                            <div class="position-relative">
                              <i class="icon-base ri ri-chat-4-line icon-sm"></i>
                              <span class="badge rounded-pill bg-info badge-dot badge-notifications"></span>
                            </div>
                            <i class="icon-base ri ri-user-3-line icon-sm"></i>
                          </div>
                          <p class="mb-0">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-right">
                        ...
                        <div class="card-body pb-4 pt-0">
                          <div class="hours mb-2">
                            ...
                            <span>1.1 Hours</span>
                            <i class="icon-base ri ri-arrow-left-right-line icon-sm mx-2"></i>
                            <span>Weekly</span>
                          </div>
                          <div class="location">
                            <i class="icon-base ri ri-map-pin-line icon-sm"></i>
                        ...
                        <div class="card-footer d-flex justify-content-between">
                          ...
                          <div>
                            <i class="icon-base ri ri-more-2-line icon-sm cursor-pointer"></i>
                          </div>
                        </div>
                    ...
                    <li class="timeline-item">
                      <span
                        ...
                        data-aos="zoom-in"
                        data-aos-delay="200">
                        <i class="icon-base ri ri-server-line"></i>
                      </span>
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div class="card-header d-flex justify-content-between">
                          <h6 class="card-title mb-0">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                          <div class="server-icons">
                            <i class="icon-base ri ri-share-line icon-sm me-2"></i>
    ...
    <!-- Vendors JS -->
    <script src="<?= base_url('assets/'); ?>vendor/libs/animate-on-scroll/animate-on-scroll.js"></script>
