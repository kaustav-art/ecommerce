...
<html
  ...
  <head>
    ...
    <title>Demo: Cards Statistics- UI elements | Materialize - Bootstrap Dashboard PRO</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row g-6">
                  ...
                  <div class="card">
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end">
                        <div class="card-body pb-0 pt-4">
                          <img
                            src="<?= base_url('assets/'); ?>img/illustrations/card-customers-illustration.png"
                            alt="Ratings"
                            class="img-fluid"
                            width="84" />
                        </div>
                  ...
                  <div class="card">
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end">
                        <div class="card-body pb-0 pt-4">
                          <img
                            src="<?= base_url('assets/'); ?>img/illustrations/card-orders-illustration.png"
                            alt="Ratings"
                            class="img-fluid"
                            width="78" />
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <i class="icon-base ri ri-arrow-up-s-line text-danger"></i>
                        </div>
                      </div>
                      <div class="card-info mt-5">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide card pb-5 shadow-none border-0">
                        ...
                        <div class="d-flex align-items-center mt-5">
                          <img
                            src="<?= base_url('assets/'); ?>/img/products/card-apple-iphone-x.png"
                            alt="Weekly sales"
                            width="84"
                            class="rounded-4" />
                        ...
                        <div class="mt-6">
                          <button type="button" class="btn btn-sm btn-outline-primary me-4">
                            <i class="tf-icons icon-base ri ri-sticky-note-line icon-14px me-1"></i>Details
                          </button>
                          <button type="button" class="btn btn-sm btn-primary">
                            <i class="tf-icons icon-base ri ri-download-line icon-14px me-1"></i>Report
                          </button>
                        </div>
                      </div>
                      <div class="swiper-slide card pb-5 shadow-none border-0">
                ...
                <div class="col-lg-6">
                  <div
                    class="card swiper-container swiper-container-horizontal swiper text-bg-primary h-100"
