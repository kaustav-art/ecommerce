...
<html
  ...
  <head>
    ...
    <title>Demo: Selects and tags - Forms | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                          ...
                          <div class="form-floating form-floating-outline">
                            <select id="select2Icons" class="select2-icons form-select">
                              <optgroup label="Services">
                                <option value="wordpress2" data-icon="icon-base ri ri-wordpress-fill" selected>
                                  WordPress
                                </option>
                              ...
                              <optgroup label="File types">
                                ...
                                <option value="facebook" data-icon="icon-base ri ri-facebook-circle-fill">
                                  Facebook
                                </option>
                              </optgroup>
                      ...
                      <div class="row g-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <button type="button" class="btn btn-sm rounded-pill btn-icon btn-outline-primary mb-1">
                            <span class="icon-base ri ri-add-line icon-18px"></span>
                          </button>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-floating form-floating-outline">
                            <select
                              ...
                              data-tick-icon="icon-base ri ri-check-line"
                              data-style="btn-default">
    ...
    <script src="<?= base_url('assets/'); ?>js/forms-tagify.js"></script>
    <script src="<?= base_url('assets/'); ?>js/forms-typeahead.js"></script>
  </body>
</html>
