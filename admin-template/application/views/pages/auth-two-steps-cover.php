...
<html
  ...
  <head>
    ...
    <title>Demo: Two Steps Verifications Cover - Pages | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/auth-two-steps-illustration-light.png"
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            ...
            <form id="twoStepsForm" action="<?= site_url('dashboard'); ?>" method="GET">
