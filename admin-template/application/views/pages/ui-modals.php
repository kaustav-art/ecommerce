                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mt-4 gap-2 gap-sm-0 align-items-center">
                                  ...
                                  <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <div class="onboarding-media">
                                        <div class="mx-2">
                                          <img
                                            src="<?= base_url('assets/'); ?>img/illustrations/girl-with-laptop-light.png"
                      ...
                      additional information from the customer when they land on the app page.</div> -->
                                    ...
                                    <div class="carousel-item">
                                      <div class="onboarding-media">
                                        <div class="mx-2">
                                          <img
                                            src="<?= base_url('assets/'); ?>img/illustrations/boy-with-laptop-light.png"
                                    ...
                                    <div class="carousel-item">
                                      <div class="onboarding-media">
                                        <div class="mx-2">
                                          <img
                                            src="<?= base_url('assets/'); ?>img/illustrations/girl-verify-password-light.png"
                                  ...
                                  <a
                                    ...
                                    data-bs-slide="prev">
                                    <i
                                      class="icon-base ri ri-arrow-left-double-line icon-18px scaleX-n1-rtl lh-1 me-1"></i
                                    ><span>Previous</span>
                                  </a>
                                  <a
                                    ...
                                    <span>Next</span
                                    ><i
                                      class="icon-base ri ri-arrow-right-double-line icon-18px scaleX-n1-rtl lh-1 ms-1"></i>
                                  </a>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="modal-content text-center">
                                ...
                                <div class="modal-body p-0">
                                  <div class="onboarding-media">
                                    <div class="mx-2">
                                      <img
                                        src="<?= base_url('assets/'); ?>img/illustrations/girl-unlock-password-light.png"
                                  ...
                                  <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <div class="onboarding-horizontal">
                                        <div class="onboarding-media">
                                          <img
                                            src="<?= base_url('assets/'); ?>img/illustrations/boy-with-rocket-light.png"
                            ...
                            <div class="modal-dialog modal-xl" role="document">
                              <div class="modal-content text-center">
                                ...
                                <div class="modal-body onboarding-horizontal p-0">
                                  <div class="onboarding-media">
                                    <img
                                      src="<?= base_url('assets/'); ?>img/illustrations/boy-verify-email-light.png"
