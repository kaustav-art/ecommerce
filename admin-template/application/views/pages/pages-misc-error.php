...
<html
  ...
  <head>
    ...
    <title>Demo: Error - Pages | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
    ...
    <div class="misc-wrapper">
      ...
      <h4 class="mb-2">Page Not Found âš ï¸</h4>
      ...
      <div class="d-flex justify-content-center mt-9">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/misc-error-illustration.png"
            alt="misc-error"
            class="img-fluid z-1"
            width="190" />
          <div>
