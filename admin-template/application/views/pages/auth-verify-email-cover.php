...
<html
  ...
  <head>
    ...
    <title>Demo: Verify Email Cover - Pages | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover">
      <!-- Logo -->
      <a href="<?= site_url('dashboard'); ?>" class="auth-cover-brand d-flex align-items-center gap-2">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/auth-verify-email-illustration-light.png"
          ...
          <img
            alt="mask"
            src="<?= base_url('assets/'); ?>img/illustrations/auth-basic-login-mask-light.png"
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            <h4 class="mb-1">Verify your email âœ‰ï¸</h4>
            <p class="text-start mb-0">
              Account activation link sent to your email address: <span class="h6">hello@example.com</span> Please
              follow the link inside to continue.
            </p>
            <a class="btn btn-primary w-100 my-5" href="<?= site_url('dashboard'); ?>"> Skip for now </a>
            <p class="text-center">
              Didn't get the mail?
