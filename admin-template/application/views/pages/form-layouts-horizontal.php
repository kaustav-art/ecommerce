...
<html
  ...
  <head>
    ...
    <title>Demo: Horizontal Layouts - Forms | Materialize - Bootstrap Dashboard PRO</title>
                            ...
                            <div class="mb-4">
                              <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="collapsible-payment-cc">
                                  Credit/Debit/ATM Card <i class="icon-base ri ri-bank-card-line"></i>
                                </label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <button
                            ...
                            role="tab"
                            aria-selected="false">
                            <span class="icon-base ri ri-account-pin-circle-line d-sm-none"></span
                        ...
                        <li class="nav-item">
                          <button
                            ...
                            role="tab"
                            aria-selected="false">
                            <span class="icon-base ri ri-facebook-fill d-sm-none"></span
