...
<html
  ...
  <head>
    ...
    <title>Demo: Roles - Apps | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                    ...
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                          ...
                          <li class="avatar">
                            <span
                              class="avatar-initial rounded-circle pull-up bg-lightest text-body"
                              data-bs-toggle="tooltip"
                    ...
                    <div class="row h-100">
                      <div class="col-5">
                        <div class="d-flex align-items-end h-100 justify-content-center">
                          <img
                            src="<?= base_url('assets/'); ?>img/illustrations/add-new-role-illustration.png"
                            class="img-fluid"
                            alt="Image"
                            width="68" />
                        </div>
                              ...
                              <tbody>
                                <tr>
                                  <td class="text-nowrap fw-medium">
                                    ...
                                    <i
                                      class="icon-base ri ri-information-line icon-sm"
                                      data-bs-toggle="tooltip"
                                      data-bs-placement="top"
    ...
    <!-- Page JS -->
    <script src="<?= base_url('assets/'); ?>js/app-access-roles.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-add-role.js"></script>
  </body>
</html>
