...
<html
  ...
  <head>
    ...
    <title>Demo: Wizard Icons - Forms | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-12 mb-6">
                  ...
                  <div class="bs-stepper wizard-icons wizard-icons-example mt-2">
                    <div class="bs-stepper-header">
                        ...
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-icon">
                            <svg viewBox="0 0 54 54">
                              <use xlink:href="<?= base_url('assets/'); ?>svg/icons/form-wizard-account.svg#wizardAccount"></use>
                            </svg>
                          </span>
                      ...
                      <div class="line">
                        <i class="icon-base ri ri-arrow-right-s-line scaleX-n1-rtl"></i>
                      </div>
                      <div class="step" data-target="#personal-info">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-icon">
                            <svg viewBox="0 0 58 54">
                              <use xlink:href="<?= base_url('assets/'); ?>svg/icons/form-wizard-personal.svg#wizardPersonal"></use>
                            </svg>
                          </span>
                      ...
                      <div class="step" data-target="#address">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-icon">
                            <svg viewBox="0 0 54 54">
                              <use xlink:href="<?= base_url('assets/'); ?>svg/icons/form-wizard-address.svg#wizardAddress"></use>
                            </svg>
                          </span>
                      ...
                      <div class="step" data-target="#social-links">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-icon">
                            <svg viewBox="0 0 54 54">
                              <use
                                xlink:href="<?= base_url('assets/'); ?>svg/icons/form-wizard-social-link.svg#wizardSocialLink"></use>
                            </svg>
                          </span>
                      ...
                      <div class="step" data-target="#review-submit">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-icon">
                            <svg viewBox="0 0 54 54">
                              <use xlink:href="<?= base_url('assets/'); ?>svg/icons/form-wizard-submit.svg#wizardSubmit"></use>
                            </svg>
                          </span>
                          ...
                          <div class="row g-5">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-outline-secondary btn-prev" disabled>
                                <i class="icon-base ri ri-arrow-left-line icon-sm scaleX-n1-rtl me-sm-1"></i>
                    ...
                    <div class="bs-stepper-header">
                        ...
                        <button type="button" class="step-trigger">
                          <span class="avatar">
                            <span class="avatar-initial rounded-1">
                              <i class="icon-base ri ri-contacts-line icon-24px"></i>
                            </span>
                          </span>
                      ...
                      <div class="step" data-target="#social-links-1">
                        <button type="button" class="step-trigger">
                          <span class="avatar">
                            <span class="avatar-initial rounded-1">
                              <i class="icon-base ri ri-instagram-line icon-24px"></i>
                            </span>
                          </span>
                          <span class="bs-stepper-label flex-column align-items-start ms-2">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <div
                    class="bs-stepper vertical wizard-modern wizard-vertical-icons wizard-modern-vertical-icons-example mt-2">
                    <div class="bs-stepper-header">
    ...
    <script src="<?= base_url('assets/'); ?>js/form-wizard-icons.js"></script>
  </body>
</html>
