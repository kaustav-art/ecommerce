...
<html
  ...
  <head>
    ...
    <title>Demo: Checkout - Wizard Examples | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>vendor/css/pages/wizard-ex-checkout.css" />
  ...
  <body>
                ...
                <div class="bs-stepper-header m-auto border-0">
                    ...
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewbox="0 0 58 54">
                          <use xlink:href="<?= base_url('assets/'); ?>svg/icons/wizard-checkout-cart.svg#wizardCart"></use>
                        </svg>
                      </span>
                    ...
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewbox="0 0 54 54">
                          <use
                            xlink:href="<?= base_url('assets/'); ?>svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress"></use>
                        </svg>
                      </span>
                  ...
                  <div class="step" data-target="#checkout-payment">
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewbox="0 0 58 54">
                          <use xlink:href="<?= base_url('assets/'); ?>svg/icons/wizard-checkout-payment.svg#wizardPayment"></use>
                        </svg>
                      </span>
                  ...
                  <div class="step" data-target="#checkout-confirmation">
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-icon">
                        <svg viewbox="0 0 58 54">
                          <use xlink:href="<?= base_url('assets/'); ?>svg/icons/wizard-checkout-confirmation.svg#wizardConfirm"></use>
                        </svg>
                      </span>
                          ...
                          <ul class="list-group mb-4">
                            <li class="list-group-item p-5">
                              <div class="d-flex gap-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/1.png" alt="google home" class="w-px-100" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item p-5">
                              <div class="d-flex gap-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/2.png" alt="google home" class="w-px-100" />
                                </div>
                                <div class="flex-grow-1">
                                  <div class="row text-center text-sm-start">
                                    <div class="col-md-8">
                            ...
                            <div class="col-md">
                              <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="customRadioAddress2">
                                  ...
                                  <span class="custom-option-body">
                                    <small class="d-xxl-block pe-xxl-12 me-xxl-12"
                                      >8723 Schoffman Avenue, New York, NY, 10016.<br />Mobile : 1234567890 Cash / Card
                                      on delivery available</small
                                    >
                                    <span class="my-2 border-bottom d-block"></span>
                                    <span class="d-flex">
                                      <a class="me-4" href="javascript:void(0)">Edit</a>
                          ...
                          <div class="border rounded p-5 mb-4">
                            ...
                            <ul class="list-unstyled">
                              <li class="d-flex gap-4 mb-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/1.png" alt="google home" class="w-px-50" />
                                </div>
                                <div class="flex-grow-1">
                                  <p class="mb-0">
                              ...
                              <li class="d-flex gap-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/2.png" alt="google home" class="w-px-50" />
                                </div>
                                <div class="flex-grow-1">
                                  <p class="mb-0">
                    ...
                    <div id="checkout-confirmation" class="content">
                      <div class="row mb-6">
                        <div class="col-12 col-lg-8 mx-auto text-center mb-2">
                          ...
                          <p>
                            We sent an email to
                            <a href="mailto:john.doe@example.com" class="h6 mb-0">john.doe@example.com</a>
                          ...
                          <p class="d-flex align-items-center justify-content-center">
                            <span> <i class="icon-base ri ri-time-line icon-20px text-heading me-1"></i> </span>Time
                            placed: 25/05/2020 13:35pm
                          </p>
                        </div>
                        ...
                        <div class="col-xl-9 mb-4 mb-xl-0">
                          <ul class="list-group">
                            <li class="list-group-item p-5">
                              <div class="d-flex gap-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/1.png" alt="google home" class="w-px-75" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item p-5">
                              <div class="d-flex gap-4">
                                <div class="flex-shrink-0">
                                  <img src="<?= base_url('assets/'); ?>img/products/2.png" alt="google home" class="w-px-75" />
                                </div>
                                <div class="flex-grow-1">
                                  <div class="row d-flex align-items-center">
                                    <div class="col-md-8 pt-2">
    ...
    <script src="<?= base_url('assets/'); ?>js/wizard-ex-checkout.js"></script>
  </body>
</html>
