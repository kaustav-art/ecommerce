...
<html
  ...
  <head>
    ...
    <title>Demo: Forgot Password Cover - Pages | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/auth-forgot-password-illustration-light.png"
            class="auth-cover-illustration w-100"
            alt="auth-illustration"
            data-app-light-img="illustrations/auth-forgot-password-illustration-light.png"
            data-app-dark-img="illustrations/auth-forgot-password-illustration-dark.png" />
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/auth-cover-forgot-password-mask-light.png"
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-5" action="<?= site_url('pages/auth-reset-password-cover'); ?>" method="GET">
            ...
            <div class="text-center">
              <a href="<?= site_url('pages/auth-login-cover'); ?>" class="d-flex align-items-center justify-content-center">
