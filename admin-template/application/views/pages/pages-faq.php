...
<html
  ...
  <head>
    ...
    <title>Demo: FAQ - Pages | Materialize - Bootstrap Dashboard PRO</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div
                ...
                <img
                  src="<?= base_url('assets/'); ?>img/pages/header-light.png"
                ...
                <div class="input-wrapper mb-6 mt-7 input-group input-group-merge">
                  ...
                  <div class="tab-content p-0">
                      ...
                      <div class="d-flex mb-4 gap-4">
                        <div class="avatar avatar-md">
                          <div class="avatar-initial bg-label-primary rounded-4">
                            <i class="icon-base ri ri-bank-card-line icon-30px"></i>
                          </div>
                        </div>
                        <div>
                          <h5 class="mb-0">
                      ...
                      <div id="accordionPayment" class="accordion">
                        ...
                        <div class="accordion-item">
                          ...
                          <div id="accordionPayment-2" class="accordion-collapse collapse">
                            <div class="accordion-body">
                              We accept VisaÂ®, MasterCardÂ®, American ExpressÂ®, and PayPalÂ®. Our servers encrypt all
                        ...
                        <div class="accordion-item active">
                          ...
                          <div id="accordionDelivery-1" class="accordion-collapse collapse show">
                            <div class="accordion-body">
                              ...
                              you the â€œroom of choiceâ€ scheduled delivery service. For small products, we offer free
                              parcel delivery.
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="cancellation" role="tabpanel">
                      <div class="d-flex mb-4 gap-4 align-items-center">
                        <div class="avatar avatar-md">
                          <span class="avatar-initial bg-label-primary rounded-4">
                            <i class="icon-base ri ri-refresh-line icon-30px"></i>
                          </span>
                        </div>
                        <div>
                    ...
                    <div class="tab-pane fade" id="orders" role="tabpanel">
                      <div class="d-flex mb-4 gap-4 align-items-center">
                        <div class="avatar avatar-md">
                          <span class="avatar-initial bg-label-primary rounded-4">
                            <i class="icon-base ri ri-inbox-archive-line icon-30px"></i>
                          </span>
                        </div>
                        <div>
                          <h5 class="mb-0">
                          ...
                          <div id="accordionOrders-3" class="accordion-collapse collapse">
                            <div class="accordion-body">
                              <p>
                                ...
                                <span class="fw-medium">â€œMy Ordersâ€</span>.
                              </p>
                              <p class="mb-0">
                    ...
                    <div class="tab-pane fade" id="product" role="tabpanel">
                      <div class="d-flex mb-4 gap-4 align-items-center">
                        <div class="avatar avatar-md">
                          <span class="avatar-initial bg-label-primary rounded-4">
                            <i class="icon-base ri ri-settings-4-line icon-30px"></i>
                          </span>
                        </div>
                        <div>
                          <h5 class="mb-0">
                        ...
                        <div class="accordion-item">
                          ...
                          <div id="accordionProduct-3" class="accordion-collapse collapse">
                            <div class="accordion-body">
                              ...
                              of protection to the standard manufacturerâ€™s warranty provided by us. To purchase or find
              ...
              <div class="row justify-content-center gap-sm-0 gap-6">
                  ...
                  <div class="p-6 rounded-4 bg-faq-section d-flex align-items-center flex-column">
                    <div class="avatar avatar-md">
                      <span class="avatar-initial bg-label-primary rounded-3">
                        <i class="icon-base ri ri-phone-line icon-30px"></i>
                      </span>
                    </div>
                ...
                <div class="col-sm-6">
                  <div class="p-6 rounded-4 bg-faq-section d-flex align-items-center flex-column">
                    <div class="avatar avatar-md">
                      <span class="avatar-initial bg-label-primary rounded-3">
                        <i class="icon-base ri ri-mail-line icon-30px"></i>
                      </span>
                    </div>
