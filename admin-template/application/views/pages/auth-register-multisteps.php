...
<html
  ...
  <head>
    ...
    <title>Demo: Multi Steps Sign-up - Pages | Materialize - Bootstrap Dashboard PRO</title>
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-3 align-items-center justify-content-center p-12 mt-12 mt-xxl-0">
          <img
            ...
            src="<?= base_url('assets/'); ?>img/illustrations/auth-register-multi-steps-illustration.png"
                      ...
                      <div class="col-sm-6 form-password-toggle mb-5 form-control-validation">
                        <div class="input-group input-group-merge">
                          ...
                          <span class="input-group-text cursor-pointer" id="multiStepsPass2"
                            ><i class="icon-base ri ri-eye-off-line ri-20px"></i
                          ></span>
                        </div>
                      </div>
                      <div class="col-sm-6 form-password-toggle mb-5 form-control-validation">
                    ...
                    <div class="row gx-5">
                      ...
                      <div class="col-12 d-flex justify-content-between form-control-validation">
                        ...
                        <button type="submit" class="btn btn-success btn-next btn-submit">
                          Submit <i class="icon-base ri ri-check-line icon-16px ms-1_5"></i>
                        </button>
                      </div>
                    </div>
                    <!--/ Credit Card Details -->
