...
<html
  ...
  <head>
    ...
    <title>Demo: Buttons - UI elements | Materialize - Bootstrap Dashboard PRO</title>
                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="row row-bordered g-0">
                      <div class="col-lg-4 p-6 pt-0">
                        <small class="fw-medium">Basic</small>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-primary">
                            <span class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary
                          </button>
                          <button type="button" class="btn btn-secondary">
                            <span class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                      ...
                      <div class="col-lg-4 p-6 pt-0">
                        <small class="fw-medium">Label(Tonal)</small>
                        <div class="demo-inline-spacing">
                  ...
                  <div class="card">
                    ...
                    <div class="row row-bordered g-0">
                      <div class="col-lg-6 p-6">
                        <small class="fw-medium">Extended Basic</small>
                        <div class="demo-inline-spacing">
                      ...
                      <div class="col-lg-6 p-6">
                        <small class="fw-medium">Extended Label</small>
                        <div class="demo-inline-spacing">
                      ...
                      <div class="col-lg-4 p-6 pt-0">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-facebook">
                            <i class="icon-base ri ri-facebook-circle-fill icon-16px me-2"></i>Facebook
                          </button>
                          <button type="button" class="btn btn-twitter">
                            <i class="icon-base ri ri-twitter-fill icon-16px me-2"></i>Twitter
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-google-plus">
                            <i class="icon-base ri ri-google-fill icon-16px me-2"></i>Google+
                          </button>
                          <button type="button" class="btn rounded-pill btn-instagram">
                            <i class="icon-base ri ri-instagram-line icon-16px me-2"></i>Instagram
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6 pt-0">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-label-linkedin">
                            <i class="icon-base ri ri-linkedin-box-fill icon-16px me-2"></i>Linkedin
                          </button>
                          <button type="button" class="btn btn-label-github">
                            <i class="icon-base ri ri-github-fill icon-16px me-2"></i>Github
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-label-pinterest">
                            <i class="icon-base ri ri-pinterest-fill icon-16px me-2"></i>Pinterest
                          </button>
                          <button type="button" class="btn rounded-pill btn-label-slack">
                            <i class="icon-base ri ri-slack-line icon-16px me-2"></i>Slack
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6 pt-0">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-outline-dribbble">
                            <i class="icon-base ri ri-dribbble-line icon-16px me-2"></i>Dribbble
                          </button>
                          <button type="button" class="btn btn-text-reddit">
                            <i class="icon-base ri ri-reddit-fill icon-16px me-2"></i>Reddit
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-outline-youtube">
                            <i class="icon-base ri ri-youtube-fill icon-16px me-2"></i>Youtube
                          </button>
                          <button type="button" class="btn rounded-pill btn-text-vimeo">
                            <i class="icon-base ri ri-vimeo-fill icon-16px me-2"></i>Vimeo
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-icon btn-facebook">
                            <i class="icon-base ri ri-facebook-circle-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon btn-twitter">
                            <i class="icon-base ri ri-twitter-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-google-plus">
                            <i class="icon-base ri ri-google-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-instagram">
                            <i class="icon-base ri ri-instagram-line icon-22px"></i>
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6">
                        <small class="fw-medium">Label(Tonal) Icons</small>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-icon btn-label-linkedin">
                            <i class="icon-base ri ri-linkedin-box-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon btn-label-github">
                            <i class="icon-base ri ri-github-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-label-pinterest">
                            <i class="icon-base ri ri-pinterest-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-label-slack">
                            <i class="icon-base ri ri-slack-line icon-22px"></i>
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-icon btn-outline-dribbble">
                            <i class="icon-base ri ri-dribbble-line icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon btn-text-reddit">
                            <i class="icon-base ri ri-reddit-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-outline-youtube">
                            <i class="icon-base ri ri-youtube-fill icon-22px"></i>
                          </button>
                          <button type="button" class="btn btn-icon rounded-pill btn-text-vimeo">
                            <i class="icon-base ri ri-vimeo-fill icon-22px"></i>
                          </button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-xl-6 mb-xl-0 mb-4">
                          ...
                          <div
                            class="btn-toolbar demo-inline-spacing gap-2"
                            role="toolbar"
