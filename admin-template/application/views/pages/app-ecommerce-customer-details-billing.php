...
<html
  ...
  <head>
    ...
    <title>
      Demo: eCommerce Customer Details Address &amp; Billing - Pages | Materialize - Bootstrap Dashboard PRO
    </title>
  ...
  <body>
                  ...
                  <div class="card bg-primary">
                    <div class="card-body">
                      <div class="row justify-content-between mb-4">
                        ...
                        <span
                          class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center text-lg-end text-xl-center text-xxl-end mx-auto mx-md-0 mb-2"
                          ><img src="<?= base_url('assets/'); ?>img/illustrations/rocket.png" class="w-px-75 m-2" alt="3dRocket"
                        /></span>
                      </div>
                      <button
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2 flex-wrap">
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-ecommerce-customer-details-overview'); ?>"
                          ><i class="icon-base ri ri-group-line icon-sm me-2"></i>Overview</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-ecommerce-customer-details-security'); ?>"
                          ><i class="icon-base ri ri-lock-2-line icon-sm me-2"></i>Security</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"
                          ><i class="icon-base ri ri-map-pin-line icon-sm me-2"></i>Address & Billing</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-ecommerce-customer-details-notifications'); ?>"
                    ...
                    <div class="card-body">
                      <div class="accordion accordion-arrow-left" id="ecommerceBillingAccordionAddress">
                        <div class="accordion-item border-bottom">
                          <div
                            class="accordion-header d-flex justify-content-between align-items-center flex-wrap flex-sm-nowrap row-gap-4"
                            id="headingHome">
                            <a
                            ...
                            <div class="d-flex gap-4 p-4 p-sm-2 py-sm-0 pt-0 ms-4 ms-sm-0">
                              <a href="javascript:void(0);"
                                ><i class="icon-base ri ri-edit-box-line icon-22px text-body"></i
                              ></a>
                              <a href="javascript:void(0);"
                                ><i class="icon-base ri ri-delete-bin-7-line icon-22px text-body"></i
                              ></a>
                              <button class="btn p-0" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                <i class="icon-base ri ri-more-2-line icon-22px text-body"></i>
                              </button>
                        ...
                        <div class="accordion-item border-bottom active">
                          <div
                            class="accordion-header d-flex justify-content-between align-items-center flex-wrap flex-sm-nowrap row-gap-4"
                            id="headingOffice">
                            <a
    ...
    <script src="<?= base_url('assets/'); ?>js/app-ecommerce-customer-detail.js"></script>
  </body>
</html>
