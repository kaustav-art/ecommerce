...
<html
  ...
  <head>
    ...
    <title>Demo: Server Error - Pages | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
    ...
    <div class="misc-wrapper">
      ...
      <h4 class="mb-2">Internal server error ðŸ”</h4>
      ...
      <div class="d-flex justify-content-center mt-12">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/misc-server-error-illustration.png"
            alt="misc-server-error"
            class="img-fluid z-1"
            width="230" />
          <div>
