...
<html
  ...
  <body>
                            ...
                            <div class="card border shadow-none">
                              <div class="card-body pt-12">
                                <div class="mt-3 mb-5 text-center">
                                  <img
                                    src="<?= base_url('assets/'); ?>img/illustrations/pricing-basic.png"
                                    alt="Basic Image"
                                    height="100" />
                                </div>
                            ...
                            <div class="card border-primary border shadow-none">
                              <div class="card-body position-relative pt-4">
                                ...
                                <div class="my-5 pt-6 text-center">
                                  <img
                                    src="<?= base_url('assets/'); ?>img/illustrations/pricing-standard.png"
                                    alt="Standard Image"
                                    height="100" />
                                </div>
                                ...
                                <ul class="list-group ps-6 my-5 pt-4">
                                  ...
                                  <li class="mb-0">Custom â€œThank youâ€ page</li>
                                </ul>
                          ...
                          <div class="col-xl">
                            <div class="card border shadow-none">
                              <div class="card-body pt-12">
                                <div class="mt-3 mb-5 text-center">
                                  <img
                                    src="<?= base_url('assets/'); ?>img/illustrations/pricing-enterprise.png"
                    ...
                    <div class="modal-body pt-4 pt-md-0 px-0 pb-md-0">
                      ...
                      <div class="row py-6">
                        <div class="col-12 col-lg-4 px-6">
                          ...
                          <div class="text-center">
                            <h6 class="mb-2">Send Invitation ðŸ¤ŸðŸ»</h6>
                        ...
                        <div class="col-12 col-lg-4 px-6">
                          ...
                          <div class="text-center">
                            <h6 class="mb-2">Registration ðŸ‘©ðŸ»â€ðŸ’»</h6>
                        ...
                        <div class="col-12 col-lg-4 px-6">
                          ...
                          <div class="text-center">
                            <h6 class="mb-2">Free Trial ðŸŽ‰</h6>
                      ...
                      <form class="row g-4" onsubmit="return false">
                        <div class="col-lg-10">
                          <label class="mb-2" for="modalRnFEmail"
                            >Enter your friendâ€™s email address and invite them to join Materialize ðŸ˜</label
                          >
                          <input
                            type="text"
                            id="modalRnFEmail"
                      ...
                      <form class="row g-4" onsubmit="return false">
                        <div class="col-lg-9">
                          <label class="mb-2" for="modalRnFLink"
                            >You can also copy and send it or share it on your social media. ðŸ¥³</label
                          >
                        ...
                        <div class="bs-stepper-content p-1">
                          <form onsubmit="return false">
                            ...
                            <div id="submit" class="content text-center pt-4 pt-lg-0">
                              ...
                              <!-- image -->
                              <img
                                src="<?= base_url('assets/'); ?>img/illustrations/create-app-modal-illustration-light.png"
                                alt="Create App img"
                                width="265"
                                class="img-fluid"
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
                  <div class="modal-content">
                    <div class="modal-body p-0">
                      ...
                      <div class="text-center mb-6">
                        <img src="<?= base_url('assets/'); ?>img/icons/misc/authentication-QR.png" alt="QR Code" width="150" />
                      </div>
                    ...
                    <div class="modal-body p-0">
                      ...
                      <div
                        ...
                        <div class="d-flex flex-wrap gap-4">
                          ...
                          <img
                            src="<?= base_url('assets/'); ?>img/icons/payments/jcb-light.png"
                            class="img-fluid w-px-50 h-px-30"
                            alt="jcb-card"
                            data-app-light-img="icons/payments/jcb-light.png"
                            data-app-dark-img="icons/payments/jcb-dark.png" />
                          <img
                            src="<?= base_url('assets/'); ?>img/icons/payments/dc-light.png"
                            class="img-fluid w-px-50 h-px-30"
    ...
    <script src="<?= base_url('assets/'); ?>js/modal-share-project.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-two-factor-auth.js"></script>
  </body>
</html>
