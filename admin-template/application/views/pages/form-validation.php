...
<html
  ...
  <head>
    ...
    <title>Demo: Validation - Forms | Materialize - Bootstrap Dashboard PRO</title>
                    ...
                    <div class="card-body">
                      <form id="formValidationExamples" class="row g-5">
                        ...
                        <div class="col-md-6 form-control-validation">
                          <div class="form-floating form-floating-outline">
                            <select
                              class="selectpicker tech-select w-100"
                              id="formValidationTech"
                              data-style="btn-default"
                              data-tick-icon="icon-base ri ri-check-line icon-sm text-white"
