...
<html
  ...
  <head>
    ...
    <title>Demo: Under Maintenance - Pages | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
    ...
    <div class="misc-wrapper">
      ...
      <div class="d-flex justify-content-center mt-9">
        <img
          src="<?= base_url('assets/'); ?>img/illustrations/misc-under-maintenance-object.png"
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            src="<?= base_url('assets/'); ?>img/illustrations/misc-under-maintenance-illustration.png"
            alt="misc-under-maintenance"
            class="img-fluid z-1"
            width="290" />
          <div>
