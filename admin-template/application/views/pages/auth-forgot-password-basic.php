        ...
        <div class="authentication-inner py-6">
          ...
          <div class="card p-md-7 p-1">
            ...
            <div class="card-body mt-1">
              ...
              <form id="formAuthentication" class="mb-5" action="<?= site_url('pages/auth-reset-password-basic'); ?>" method="GET">
          ...
          <img
            alt="mask"
            src="<?= base_url('assets/'); ?>img/illustrations/auth-basic-forgot-password-mask-light.png"
