...
<html
  ...
  <head>
    ...
    <title>Demo: Reset Password Cover - Pages | Materialize - Bootstrap Dashboard PRO</title>
      ...
      <div class="authentication-wrapper authentication-cover">
        ...
        <div class="authentication-inner row m-0">
          ...
          <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
            <img
              src="<?= base_url('assets/'); ?>img/illustrations/auth-reset-password-illustration-light.png"
              class="auth-cover-illustration w-100"
              alt="auth-illustration"
              data-app-light-img="illustrations/auth-reset-password-illustration-light.png"
              data-app-dark-img="illustrations/auth-reset-password-illustration-dark.png" />
            <img
              src="<?= base_url('assets/'); ?>img/illustrations/auth-cover-reset-password-mask-light.png"
          ...
          <div
            ...
            <div class="w-px-400 mx-auto pt-5 pt-lg-0">
              ...
              <form id="formAuthentication" class="mb-5" action="<?= site_url('pages/auth-login-cover'); ?>" method="GET">
