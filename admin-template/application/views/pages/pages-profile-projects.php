...
<html
  ...
  <head>
    ...
    <title>Demo: User Profile - Projects | Materialize - Bootstrap Dashboard PRO</title>
                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/pages-profile-user'); ?>"
                          ><i class="icon-base ri ri-user-3-line icon-sm me-2"></i> Profile</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/pages-profile-teams'); ?>"
                          ><i class="icon-base ri ri-team-line icon-sm me-2"></i> Teams</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"
                          ><i class="icon-base ri ri-computer-line icon-sm me-2"></i> Projects</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/pages-profile-connections'); ?>"
                  ...
                  <div class="card h-100">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/social-label.png"
                              alt="Avatar"
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lightest px-3 py-2 rounded-3 me-auto mb-4">
                    ...
                    <div class="card-body border-top">
                      ...
                      <div class="progress bg-label-primary mb-4 rounded rounded" style="height: 8px">
                        <div
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-1"></i>15</a
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header pb-4">
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/react-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                          <div class="me-2">
                    ...
                    <div class="card-body border-top">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                            ...
                            <li
                              ...
                              title="Alan Walker"
                              class="avatar avatar-sm pull-up me-3">
                              <img class="rounded-circle" src="<?= base_url('assets/'); ?>img/avatars/16.png" alt="Avatar" />
                            </li>
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-2"></i> 236</a
                          >
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card h-100">
                    <div class="card-header pb-4">
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/vue-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                          <div class="me-2">
                    ...
                    <div class="card-body border-top">
                      ...
                      <div class="progress mb-4 bg-label-primary rounded" style="height: 8px">
                        <div
                          class="progress-bar rounded"
                          role="progressbar"
                          style="width: 68%"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 98</a
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header pb-4">
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/html-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                          <div class="me-2">
                    ...
                    <div class="card-body border-top">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 120</a
                          >
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card h-100">
                    <div class="card-header pb-4">
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/figma-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                          <div class="me-2">
                    ...
                    <div class="card-body">
                      ...
                      <p class="mb-0">
                        Use this template to organize your design project. Some of the key features areâ€¦
                      </p>
                    </div>
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-4">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 20</a
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header pb-4">
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <div class="avatar me-4">
                            <img src="<?= base_url('assets/'); ?>img/icons/brands/xd-label.png" alt="Avatar" class="rounded-circle" />
                          </div>
                          <div class="me-2">
                            <h5 class="mb-0">
                    ...
                    <div class="card-body border-top">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                          <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"
                            ><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 16</a
                          >
                        </div>
                      </div>
                    </div>
