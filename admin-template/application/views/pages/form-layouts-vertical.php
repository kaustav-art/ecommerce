...
<html
  ...
  <head>
    ...
    <title>Demo: Vertical Layouts - Forms | Materialize - Bootstrap Dashboard PRO</title>
                      ...
                      <form>
                        ...
                        <div class="input-group input-group-merge mb-6">
                          <span id="basic-icon-default-company2" class="input-group-text"
                            ><i class="icon-base ri ri-building-4-line"></i
                          ></span>
                          <div class="form-floating form-floating-outline">
                            <input
                              type="text"
                            ...
                            <div class="mb-4">
                              <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="collapsible-payment-cc">
                                  Credit/Debit/ATM Card <i class="icon-base ri ri-bank-card-line icon-sm"></i>
                                </label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input
                                ...
                                <label class="form-check-label" for="collapsible-payment-cash">
                                  Cash On Delivery
                                  <i
                                    class="icon-base ri ri-question-line icon-sm"
                                    data-bs-toggle="tooltip"
                                    data-bs-placement="top"
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <button
                            ...
                            role="tab"
                            aria-selected="false">
                            <span class="icon-base ri ri-folder-user-line d-sm-none"></span
                        ...
                        <li class="nav-item">
                          <button
                            ...
                            role="tab"
                            aria-selected="false">
                            <span class="icon-base ri ri-facebook-circle-fill d-sm-none"></span
