...
<html
  ...
  <head>
    ...
    <title>Demo: Two Steps Verifications Basic - Pages | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <div class="positive-relative">
      <div class="authentication-wrapper authentication-basic p-4 p-sm-0">
        <div class="authentication-inner py-6">
          ...
          <img
            alt="mask"
            src="<?= base_url('assets/'); ?>img/illustrations/auth-basic-register-mask-light.png"
