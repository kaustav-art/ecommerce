...
<html
  ...
  <head>
    ...
    <title>Demo: User View - Pages | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled g-2 my-6">
                        <li class="mb-2 d-flex align-items-center">
                          <i class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>10 Users</span>
                        </li>
                        <li class="mb-2 d-flex align-items-center">
                        ...
                        <li class="mb-2 d-flex align-items-center">
                          <i class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Basic Support</span>
                        </li>
                      </ul>
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-user-view-account'); ?>"
                          ><i class="icon-base ri ri-group-line icon-sm me-2"></i>Account</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-user-view-security'); ?>"
                          ><i class="icon-base ri ri-lock-2-line icon-sm me-2"></i>Security</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"
                          ><i class="icon-base ri ri-bookmark-line icon-sm me-2"></i>Billing & Plans</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-user-view-notifications'); ?>"
                          ><i class="icon-base ri ri-notification-4-line icon-sm me-2"></i>Notifications</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/app-user-view-connections'); ?>"
                          ><i class="icon-base ri ri-link-m icon-sm me-2"></i>Connections</a
                        >
                      </li>
                    </ul>
                  </div>
                      ...
                      <div class="row row-gap-4">
                        ...
                        <div class="col-xl-6 order-0 order-xl-0">
                          <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
                            <h5 class="alert-heading mb-1 d-flex align-items-center">
                              <span class="alert-icon rounded-3"
                                ><i class="icon-base ri ri-alert-line icon-22px"></i
                              ></span>
                          ...
                          <div class="plan-statistics">
                            ...
                            <div class="progress bg-label-primary mb-1 rounded">
                              <div
                                class="progress-bar rounded"
                                style="width: 20%"
                                role="progressbar"
                    ...
                    <div class="card-header align-items-center">
                      ...
                      <div class="card-action-element">
                        <button
                          ...
                          <i class="icon-base ri ri-add-line icon-14px me-1"></i>Add Card
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                ...
                                src="<?= base_url('assets/'); ?>img/icons/payments/mastercard.png"
                                alt="Master Card" />
                        ...
                        <div class="cardMaster border p-5 rounded-4 mb-4">
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                class="mb-2 img-fluid"
                                src="<?= base_url('assets/'); ?>img/icons/payments/visa.png"
                                alt="Master Card" />
                        ...
                        <div class="cardMaster border p-5 rounded-4">
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="card-information">
                              <img
                                class="mb-2 img-fluid"
                                src="<?= base_url('assets/'); ?>img/icons/payments/american-express-logo.png"
                                alt="Visa Card" />
                              <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="card-header align-items-center">
                      ...
                      <div class="card-action-element">
                        <button
                          ...
                          <i class="icon-base ri ri-add-line icon-14px me-1"></i>Edit address
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-xl-7 col-12">
                          <dl class="row mb-0 gx-2">
                            ...
                            <dd class="col-sm-7 col-xxl-8">Materialize</dd>
                            ...
                            <dt class="col-sm-5 col-xxl-4 mb-2 text-nowrap fw-medium text-heading mb-0">
                              Billing Address:
                            </dt>
                            <dd class="col-sm-7 col-xxl-8 mb-2 mb-xl-0">
                        ...
                        <div class="col-12 form-control-validation">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text cursor-pointer" id="modalEditCard2">
                              <span class="card-type-edit"
                                ><img
                                  src="<?= base_url('assets/'); ?>img/icons/payments/visa-cc.png"
                                  height="18"
                                  alt="credit-card img"
                              /></span>
                            </span>
                        ...
                        <div class="col-6 col-md-3">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text cursor-pointer" id="modalEditCvv2"
                              ><i
                                class="icon-base ri ri-question-line text-body-secondary"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
    ...
    <!-- Page JS -->
    <script src="<?= base_url('assets/'); ?>js/modal-edit-user.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-edit-cc.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-add-new-cc.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-add-new-address.js"></script>
    <script src="<?= base_url('assets/'); ?>js/app-user-view.js"></script>
    <script src="<?= base_url('assets/'); ?>js/app-user-view-billing.js"></script>
  </body>
</html>
