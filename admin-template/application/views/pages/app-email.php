...
<html
  ...
  <head>
    ...
    <title>Demo: Email - Apps | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                  ...
                  <div class="col app-email-sidebar border-end flex-grow-0" id="app-email-sidebar">
                    ...
                    <div class="email-filters pt-4 pb-2">
                      ...
                      <div class="email-filter-labels pt-4">
                        <p class="small mx-5 text-body-secondary text-uppercase">Labels</p>
                      ...
                      <div class="card-body emails-list-header p-3 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center px-3 mt-2">
                          <div class="d-flex align-items-center w-100">
                            <i
                              class="icon-base ri ri-menu-line icon-lg cursor-pointer d-block d-lg-none me-4 mb-4"
                              data-bs-toggle="sidebar"
                              data-target="#app-email-sidebar"
                              data-overlay></i>
                            <div class="mb-4 w-100">
                              <div class="input-group input-group-merge shadow-none">
                                <span class="input-group-text border-0 p-0 pe-3" id="email-search">
                                  <i class="icon-base ri ri-search-line icon-22px text-body"></i>
                                </span>
                                <input
                                  type="text"
                        ...
                        <div class="d-flex justify-content-between align-items-center ps-1">
                          <div class="d-flex align-items-center">
                            <div class="form-check mb-0 ms-2 mt-1">
                              <input class="form-check-input" type="checkbox" id="email-select-all" />
                              <label class="form-check-label" for="email-select-all"></label>
                            </div>
                            <div class="btn btn-icon btn-text-secondary rounded-pill me-1">
                              <i
                                class="icon-base ri ri-delete-bin-7-line icon-22px email-list-delete cursor-pointer"></i>
                            </div>
                            <div class="btn btn-icon btn-text-secondary rounded-pill me-1">
                              <i class="icon-base ri ri-mail-open-line icon-22px email-list-read cursor-pointer"></i>
                            </div>
                            <div class="dropdown me-1">
                              <button
                                ...
                                aria-haspopup="true"
                                aria-expanded="false">
                                <i class="icon-base ri ri-folder-line icon-22px"></i>
                              </button>
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuFolderOne">
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="icon-base ri ri-spam-2-line icon-sm me-1"></i>
                                  <span class="align-middle">Spam</span>
                                </a>
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="icon-base ri ri-edit-box-line icon-sm me-1"></i>
                            ...
                            <div class="dropdown mx-1">
                              <button
                                ...
                                aria-expanded="true"
                                id="dropdownLabelOne">
                                <i class="icon-base ri ri-price-tag-3-line icon-22px"></i>
                              </button>
                          ...
                          <div class="d-flex align-items-center">
                            <span class="btn btn-icon btn-text-secondary rounded-pill me-1">
                              <i
                                class="icon-base ri ri-refresh-line icon-22px scaleX-n1-rtl cursor-pointer email-refresh"></i>
                            </span>
                            <div class="dropdown">
                              <button
                                class="btn btn-icon btn-text-secondary rounded-pill p-0"
                        ...
                        <ul class="list-unstyled m-0">
                          <li
                            ...
                            <div class="d-flex align-items-center w-100">
                              ...
                              <span class="ms-sm-2 me-3 d-sm-inline-block d-none"
                                ><i
                                  class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i
                              ></span>
                              <img
                                src="<?= base_url('assets/'); ?>img/avatars/1.png"
                                alt="user-avatar"
                              ...
                              <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                ...
                                <ul class="list-inline email-list-item-actions">
                                  ...
                                  <li
                                    ...
                                    <i class="icon-base ri ri-mail-line icon-22px"></i>
                                  </li>
                                  <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill">
                                    <i class="icon-base ri ri-information-line icon-22px"></i>
                                  </li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <li
                            ...
                            <div class="d-flex align-items-center w-100">
                              ...
                              <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                ...
                                <small class="email-list-item-subject d-xl-inline-block d-block">
                                  Hey Katy, Dessert souffl̩ tootsie roll souffl̩ carrot cake halvah jelly.</small
                                >
                              </div>
                              <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                <span
                          ...
                          <li
                            ...
                            <div class="d-flex align-items-center w-100">
                              ...
                              <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                ...
                                <small class="email-list-item-subject d-xl-inline-block d-block">
                                  Hey Katy, Souffl̩ apple pie caramels souffl̩ tiramisu bear claw.</small
                                >
                              </div>
                              <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                <span
                                  class="email-list-item-attachment icon-base ri ri-attachment-2 icon-22px cursor-pointer me-2 float-end float-sm-none"></span>
                                <span
                                  class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                          ...
                          <li
                            ...
                            <div class="d-flex align-items-center w-100">
                              ...
                              ></span>
                              <img
                                src="<?= base_url('assets/'); ?>img/avatars/3.png"
                                alt="user-avatar"
                                class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0"
                                height="32"
                                width="32" />
                              ...
                              <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                ...
                                <ul class="list-inline email-list-item-actions">
                                  ...
                                  <li class="list-inline-item email-read btn btn-icon btn-text-secondary rounded-pill">
                                    <i class="icon-base ri ri-mail-open-line icon-22px"></i>
                                  </li>
                                  <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill">
                                    <i class="icon-base ri ri-information-line icon-22px"></i>
                                  </li>
                          ...
                          <li
                            ...
                            <div class="d-flex align-items-center w-100">
                              ...
                              ></span>
                              <img
                                src="<?= base_url('assets/'); ?>img/avatars/4.png"
                                alt="user-avatar"
                                class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0"
                                height="32"
                                width="32" />
                  ...
                  <div class="col app-email-view flex-grow-0 bg-lightest" id="app-email-view">
                    <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center overflow-hidden">
                          <span class="ms-sm-2 me-4"
                            ><i
                              class="icon-base ri ri-arrow-left-s-line icon-22px cursor-pointer scaleX-n1-rtl"
                              data-bs-toggle="sidebar"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="btn btn-icon p-0 me-2 btn-text-secondary rounded-pill text-body-secondary">
                            <i class="icon-base ri ri-arrow-left-s-line icon-22px scaleX-n1-rtl"></i>
                          </span>
                          <span class="btn btn-icon btn-text-secondary rounded-pill p-0">
                            <i class="icon-base ri ri-arrow-right-s-line icon-22px scaleX-n1-rtl"></i>
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                          <span class="btn btn-icon btn-text-secondary rounded-pill me-1"
                            ><i class="icon-base ri ri-delete-bin-7-line icon-22px cursor-pointer"></i
                          ></span>
                          <span class="btn btn-icon btn-text-secondary rounded-pill me-1"
                            ><i
                              class="icon-base ri ri-mail-line icon-22px cursor-pointer"
                              data-bs-toggle="sidebar"
                              data-target="#app-email-view"></i
                          ></span>
                          <div class="dropdown">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="dropdown ms-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMoreOptions">
                              ...
                              <a class="dropdown-item" href="javascript:void(0)">
                                <i class="icon-base ri ri-mail-open-line me-1"></i>
                              ...
                              <a class="dropdown-item" href="javascript:void(0)">
                                <i class="icon-base ri ri-calendar-2-line me-1"></i>
                                <span class="align-middle">Create Event</span>
                              </a>
                              <a class="dropdown-item" href="javascript:void(0)">
                                <i class="icon-base ri ri-volume-mute-line me-1"></i>
                      ...
                      <div class="card email-card-prev mx-sm-6 mx-3">
                        <div
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <span class="btn btn-icon btn-text-secondary rounded-pill"
                              ><i class="icon-base ri ri-attachment-2 icon-22px cursor-pointer"></i
                            ></span>
                            <span class="btn btn-icon btn-text-secondary rounded-pill"
                              ><i
                                class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownEmailOne">
                                <a class="dropdown-item scroll-to-reply" href="javascript:void(0)">
                                  <i class="icon-base ri ri-reply-line me-1"></i>
                                  <span class="align-middle">Reply</span>
                                </a>
                                <a class="dropdown-item" href="javascript:void(0)">
                                  <i class="icon-base ri ri-share-forward-line me-1"></i>
                        ...
                        <div class="card-body pt-5">
                          ...
                          <div class="cursor-pointer">
                            <i class="icon-base ri ri-file-text-line icon-sm"></i>
                        ...
                        <div class="card-body pt-0 ps-3">
                          ...
                          <div class="d-flex justify-content-end align-items-center mt-4">
                            <div class="cursor-pointer btn btn-text-secondary text-secondary me-4">
                              <i class="icon-base ri ri-attachment-2 icon-16px text-heading me-2"></i>
                              <span class="align-middle">Attachments</span>
                            </div>
                            <button class="btn btn-primary">
                              <span class="align-middle">Send</span>
                              <i class="icon-base ri ri-send-plane-line icon-sm ms-2 scaleX-n1-rtl"></i>
                            </button>
                          </div>
                        </div>
                      </div>
                ...
                <div
                  ...
                  <div class="modal-dialog m-0 me-md-6 mb-6 modal-lg">
                    <div class="modal-content p-0">
                      <div class="modal-header py-3 justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                          <button type="button" class="btn btn-icon btn-text-secondary rounded-pill">
                            <i class="icon-base ri ri-subtract-line icon-20px"></i>
                          </button>
                          <button
                            type="button"
                      ...
                      <div class="modal-body flex-grow-1 pb-sm-0 px-5 py-2">
                        <form class="email-compose-form">
                          ...
                          <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
                            <div class="d-flex align-items-center">
                              <div class="btn-group">
                                <button
                                  ...
                                  data-bs-toggle="dropdown"
                                  aria-expanded="false">
                                  Send <i class="icon-base ri ri-send-plane-line icon-sm scaleX-n1-rtl ms-2"></i>
                                </button>
                              ...
                              <label for="attach-file" class="btn btn-icon btn-text-secondary rounded-pill ms-4"
                                ><i class="icon-base ri ri-attachment-2 cursor-pointer icon-20px"></i
                              ></label>
                            ...
                            <div class="d-flex align-items-center gap-4">
                              <div class="dropdown">
                                <button
                                  class="btn btn-sm btn-icon btn-text-secondary p-0"
                                  type="button"
    ...
    <script src="<?= base_url('assets/'); ?>vendor/libs/notiflix/notiflix.js"></script>
