...
<html
  ...
  <head>
    ...
    <title>Demo: Create Deal - Wizard Examples | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                      ...
                      <div class="row g-6">
                        <div class="col-12">
                          <img
                            ...
                            src="<?= base_url('assets/'); ?>img/illustrations/shopping-girl.png"
                            alt="Shopping Girl" />
                        </div>
                        <div class="col-12">
                          <div class="row g-5">
                              ...
                              <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content" for="customRadioPercentage">
                                  <span class="custom-option-body">
                                    <i class="icon-base ri ri-percent-line icon-28px"></i>
                      ...
                      <div class="row g-3">
                            ...
                            <div class="col-12 mb-0">
                              <table class="table table-borderless">
                                <tbody>
                                  ...
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1 fw-medium">
                        ...
                        <div class="col-lg-6 d-flex align-items-center justify-content-center border rounded-3 pt-3">
                          <img
                            ...
                            src="<?= base_url('assets/'); ?>img/illustrations/create-deal-review-complete.png"
    ...
    <script src="<?= base_url('assets/'); ?>js/wizard-ex-create-deal.js"></script>
  </body>
</html>
