...
<html
  ...
  <head>
    ...
    <title>Demo: Login Cover - Pages | Materialize - Bootstrap Dashboard PRO</title>
          ...
          <div class="w-px-400 mx-auto pt-12 pt-lg-0">
            ...
            <form id="formAuthentication" class="mb-5" action="<?= site_url('dashboard'); ?>" method="GET">
              ...
              <div class="mb-5 d-flex justify-content-between mt-5">
                ...
                <a href="<?= site_url('pages/auth-forgot-password-cover'); ?>" class="float-end mb-1 mt-2">
            ...
            <p class="text-center">
              ...
              <a href="<?= site_url('pages/auth-register-cover'); ?>">
