...
<html
  ...
  <head>
    ...
    <title>Demo: eCommerce Referral - App | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge bg-label-info rounded-circle p-2">
                          <i class="icon-base ri ri-refresh-line icon-24px"></i>
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-6">
                        <div class="d-flex flex-column align-items-center">
                          <span
                            class="p-4 border-1 border-primary rounded-circle border-dashed mb-0 w-px-75 h-px-75 text-primary">
                            <svg
                          ...
                          <div class="row gx-4 gy-2">
                            <div class="col-sm-9 col-lg-8">
                              <input
                                ...
                                placeholder="Enter friendâ€™s email address" />
                            </div>
                            <div class="col-sm-3 col-lg-4">
                              <button type="submit" class="btn btn-primary">
                                <i class="icon-base ri ri-check-line icon-16px me-2"></i>Submit
                              </button>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-sm-3 col-lg-4">
                              <div class="d-flex gap-2">
                                <button type="button" class="btn btn-facebook btn-icon">
                                  <i class="icon-base ri ri-facebook-circle-line text-white icon-22px"></i>
                                </button>
                                <button type="button" class="btn btn-twitter btn-icon">
                                  <i class="icon-base ri ri-twitter-line text-white icon-22px"></i>
                                </button>
                              </div>
                            </div>
                          </div>
    ...
    <!-- Page JS -->
    <script src="<?= base_url('assets/'); ?>js/app-ecommerce-referral.js"></script>
  </body>
</html>
