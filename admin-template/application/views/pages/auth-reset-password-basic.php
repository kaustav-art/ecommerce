...
<html
  ...
  <head>
    ...
    <title>Demo: Reset Password Basic - Pages | Materialize - Bootstrap Dashboard PRO</title>
        ...
        <div class="authentication-inner py-6">
          <div class="card p-md-7 p-1">
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-5" action="<?= site_url('pages/auth-login-basic'); ?>" method="GET">
          ...
          <img
            alt="mask"
            src="<?= base_url('assets/'); ?>img/illustrations/auth-basic-reset-password-mask-light.png"
