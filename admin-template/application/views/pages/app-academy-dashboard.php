...
<html
  ...
  <head>
    ...
    <title>Demo: Academy - Dashboard - App | Materialize - Bootstrap Dashboard PRO</title>
              ...
              <div class="card bg-transparent shadow-none border-0 mb-6">
                <div class="card-body row g-6 p-0 pb-5">
                  <div class="col-12 col-md-8 card-separator">
                    <h5 class="mb-2">Welcome back,<span class="h4 fw-semibold"> Felecia ðŸ‘‹ðŸ»</span></h5>
                        ...
                        <li class="d-flex mb-7">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-primary"
                              ><i class="icon-base ri ri-vidicon-line icon-24px"></i
                            ></span>
                          </div>
