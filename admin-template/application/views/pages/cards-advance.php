...
<html
  ...
  <head>
    ...
    <title>Demo: Cards Advance- UI elements | Materialize - Bootstrap Dashboard PRO</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>vendor/libs/raty-js/raty-js.css" />
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row g-6">
                          ...
                          <div class="me-4">
                            <div class="avatar flex-shrink-0">
                              <div class="avatar-initial bg-label-success rounded-3">
                                <div>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/icons/payments/credit-card.png"
                                    alt="credit-card"
                                    class="img-fluid" />
                                </div>
                              </div>
                          ...
                          <div class="me-4">
                            <div class="avatar flex-shrink-0">
                              <div class="avatar-initial bg-label-primary rounded-3">
                                <div>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/icons/payments/paypal-primary.png"
                                    alt="paypal"
                                    class="img-fluid" />
                                </div>
                              </div>
                          ...
                          <div class="me-4">
                            <div class="avatar flex-shrink-0">
                              <div class="avatar-initial bg-label-info rounded-3">
                                <div>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/icons/payments/mastercard-info.png"
                                    alt="mastercard"
                                    class="img-fluid" />
                                </div>
                              </div>
                          ...
                          <div class="me-4">
                            <div class="avatar flex-shrink-0">
                              <div class="avatar-initial bg-label-danger rounded-3">
                                <div>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/icons/payments/wallet.png"
                                    alt="wallet"
                                    class="img-fluid" />
                                </div>
                              </div>
                          ...
                          <div class="me-4">
                            <div class="avatar flex-shrink-0">
                              <div class="avatar-initial bg-label-warning rounded-3">
                                <div>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/icons/payments/stripe.png"
                                    alt="Stripe"
                                    class="img-fluid" />
                                </div>
                              </div>
                    ...
                    <div class="card-body">
                      ...
                      <form id="paymentDetailsForm" onsubmit="return false">
                        ...
                        <div class="d-flex align-items-center mb-2">
                          <div class="me-3">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/payments/logo-mastercard-small.png"
                              alt="credit card"
                              height="30" />
                          </div>
                        ...
                        <div class="d-flex align-items-center mb-2">
                          <div class="me-3">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/payments/logo-credit-card-2.png"
                              alt="credit card"
                              height="30" />
                          </div>
                          <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/4.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/5.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/3.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/14.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-4 pb-2">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/8.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center">
                          <div class="avatar flex-shrink-0 me-4">
                            <img src="<?= base_url('assets/'); ?>img/avatars/1.png" alt="avatar" class="rounded-3" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                              <div>
                                <img src="<?= base_url('assets/'); ?>img/icons/misc/3d-illustration.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                              <div>
                                <img src="<?= base_url('assets/'); ?>img/icons/misc/finance-app-design.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                              <div>
                                <img src="<?= base_url('assets/'); ?>img/icons/misc/4-square.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                              <div>
                                <img src="<?= base_url('assets/'); ?>img/icons/misc/delta-web-app.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-light-gray rounded-3">
                              <div>
                                <img src="<?= base_url('assets/'); ?>img/icons/misc/ecommerce-website.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            <div class="avatar avatar-sm">
                              <img src="<?= base_url('assets/'); ?>img/icons/brands/google.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="<?= base_url('assets/'); ?>img/icons/brands/facebook-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="<?= base_url('assets/'); ?>img/icons/brands/instagram-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="<?= base_url('assets/'); ?>img/icons/brands/reddit-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-4">
                          <div class="flex-shrink-0">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/facebook-rounded.png"
                              alt="facebook"
                              class="me-3"
                              height="34" />
                          </div>
                        ...
                        <li class="d-flex align-items-center mb-4">
                          <div class="flex-shrink-0">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/dribbble-rounded.png"
                              alt="dribbble"
                              class="me-3"
                              height="34" />
                          </div>
                        ...
                        <li class="d-flex align-items-center mb-4">
                          <div class="flex-shrink-0">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/twitter-light.png"
                              alt="twitter"
                              class="me-3"
                              height="34"
                        ...
                        <li class="d-flex align-items-center">
                          <div class="flex-shrink-0">
                            <img
                              src="<?= base_url('assets/'); ?>img/icons/brands/instagram-rounded.png"
                              alt="instagram"
                              class="me-3"
                              height="34" />
                          </div>
                          ...
                          <tbody class="table-border-bottom-0">
                            ...
                            <tr>
                              <td class="ps-0 pe-12 pt-4">
                                <i class="icon-base ri ri-circle-fill icon-14px text-info me-3"></i>
                        ...
                        <tbody>
                          <tr>
                            <td class="d-flex align-items-center pt-5">
                              <div class="rounded-3 bg-light-gray d-flex h-px-30">
                                <img
                                  src="<?= base_url('assets/'); ?>img/icons/payments/visa-light.png"
                                  width="46"
                                  alt="visa-card"
                          ...
                          <tr>
                            <td class="d-flex align-items-center">
                              <div class="rounded-3 bg-light-gray d-flex h-px-30">
                                <img
                                  src="<?= base_url('assets/'); ?>img/icons/payments/master-light.png"
                                  width="46"
                                  alt="master-card"
                          ...
                          <tr>
                            <td class="d-flex align-items-center">
                              <div class="rounded-3 bg-light-gray d-flex h-px-30">
                                <img
                                  src="<?= base_url('assets/'); ?>img/icons/payments/ae-light.png"
                                  width="46"
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="d-flex justify-content-end align-items-center pt-5">
                              ...
                              <i class="icon-base ri ri-arrow-up-s-line text-success icon-24px ms-1"></i>
                            </td>
                          </tr>
                          <tr>
                            <td class="d-flex align-items-center">
                          ...
                          <tr>
                            ...
                            <td class="d-flex justify-content-end align-items-center">
                              ...
                              <i class="icon-base ri ri-arrow-down-s-line text-danger icon-24px ms-1"></i>
                            </td>
                          </tr>
                          <tr>
                            <td class="d-flex align-items-center">
                        ...
                        <li class="d-flex mb-6 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded-3 bg-label-success"
                              ><i class="icon-base ri ri-check-line text-success icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-6 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded-3 bg-label-warning"
                              ><i class="icon-base ri ri-home-line icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-6 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded-3 bg-label-secondary"
                              ><i class="icon-base ri ri-timer-line icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <div class="card-body">
                      <ul class="list-unstyled mb-0">
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-primary"
                              ><i class="icon-base ri ri-video-download-line icon-24px"></i
                            ></span>
                          </div>
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-info"
                              ><i class="icon-base ri ri-code-fill icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-sm-flex w-100 align-items-center">
                            <div class="w-100 mb-2 mb-sm-0 me-sm-4">
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-success"
                              ><i class="icon-base ri ri-image-2-line icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-sm-flex w-100 align-items-center">
                            <div class="w-100 mb-2 mb-sm-0 me-sm-4">
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-warning"
                              ><i class="icon-base ri ri-palette-line icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-sm-flex w-100 align-items-center">
                            <div class="w-100 mb-2 mb-sm-0 me-sm-4">
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-4">
                            <span class="avatar-initial rounded-3 bg-label-danger"
                              ><i class="icon-base ri ri-music-2-line icon-24px"></i
                            ></span>
                          </div>
                          <div class="d-sm-flex w-100 align-items-center">
                            <div class="w-100 mb-2 mb-sm-0 me-sm-4">
                    ...
                    <div class="card-body">
                      <div class="bg-label-primary text-center mb-6 pt-2 rounded-3">
                        <img
                          ...
                          src="<?= base_url('assets/'); ?>img/illustrations/faq-illustration.png"
                          alt="Boy card image" />
                      </div>
                ...
                <div class="col-lg-6 col-xxl-8">
                  <div class="card">
                    <img
                      src="<?= base_url('assets/'); ?>/img/elements/activity-timeline.png"
                      alt="timeline-image"
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex align-items-center mb-1">
                              <div class="badge bg-lighter rounded-3">
                                <img src="<?= base_url('assets/'); ?>/img/icons/misc/pdf.png" alt="img" width="20" class="me-2" />
                ...
                <div class="col-12 col-xxl-4 col-lg-6">
                  <div class="card">
                    <img class="card-img-top" src="<?= base_url('assets/'); ?>/img/elements/iPhone-bg.png" alt="iPhone-bg" />
                    <div class="card-body">
                      ...
                      <p class="my-4 small">
                        Managing your money isnâ€™t the easiest thing to do. Now that many of us no longer balance a
                        checkbook, tracking and expenses.
                      </p>
                      <div class="mb-4">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                          <div class="me-3 text-body-secondary">
                            <i class="icon-base ri ri-attachment-line icon-24px"></i>
                            <span class="fw-medium">24</span>
                          </div>
                          <div class="me-2 text-body-secondary">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <div class="avatar me-4">
                                  <img src="<?= base_url('assets/'); ?>img/avatars/8.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <div class="avatar me-4">
                                  <img src="<?= base_url('assets/'); ?>img/avatars/11.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                        ...
                        <div class="tab-content border-0 pb-0 px-6 mx-1">
                          <div class="tab-pane fade show active" id="navs-justified-new" role="tabpanel">
                            ...
                            <ul class="timeline mb-0">
                              ...
                              <li class="timeline-item ps-6 border-none">
                                <span class="timeline-indicator-advanced border-0 shadow-none">
                                  <i class="icon-base ri ri-map-pin-line text-primary"></i>
                                </span>
                                <div class="timeline-event ps-1">
                                  <div class="timeline-header">
                                    <small class="text-primary text-uppercase fw-medium">Receiver</small>
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 bg-light-gray rounded-3 me-3">
                            <img src="<?= base_url('assets/'); ?>img/icons/misc/zipcar.png" alt="zipcar" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 bg-light-gray rounded-3 me-3">
                            <img src="<?= base_url('assets/'); ?>img/icons/misc/bitbank.png" alt="bitbank" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-6">
                          <div class="avatar flex-shrink-0 bg-light-gray rounded-3 me-3">
                            <img src="<?= base_url('assets/'); ?>img/icons/misc/aviato.png" alt="aviato" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                      ...
                      <ul
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="true">
                            <div>
                              <img src="<?= base_url('assets/'); ?>img/products/apple-iPhone-13.png" alt="Mobile" class="img-fluid" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            <div>
                              <img
                                src="<?= base_url('assets/'); ?>img/products/apple-iMac-3k.png"
                                alt="Apple iMac 3k"
                                class="img-fluid" />
                            </div>
                          </a>
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            <div>
                              <img
                                src="<?= base_url('assets/'); ?>img/products/gaming-remote.png"
                                alt="Gaming Remote"
                                class="img-fluid" />
                            </div>
                          </a>
                          ...
                          <a
                            ...
                            <div class="avatar avatar-sm">
                              <div class="avatar-initial bg-label-secondary text-body rounded">
                                <i class="icon-base ri ri-add-line ri-22px"></i>
                              </div>
                            </div>
                          </a>
                        </li>
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/products/google-pixel-6.png"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/products/apple-iMac-4k.png"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="<?= base_url('assets/'); ?>img/products/sup-game-box-400.png"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
    ...
    <script src="<?= base_url('assets/'); ?>vendor/libs/raty-js/raty-js.js"></script>
    ...
    <!-- Page JS -->
    <script src="<?= base_url('assets/'); ?>js/cards-advance.js"></script>
    <script src="<?= base_url('assets/'); ?>js/modal-add-new-cc.js"></script>
  </body>
</html>
