...
<html
  ...
  <body>
                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="<?= site_url('pages/pages-account-settings-security'); ?>"
    ...
    <!-- Page JS -->
    <script src="<?= base_url('assets/'); ?>js/pages-pricing.js"></script>
    <script src="<?= base_url('assets/'); ?>js/pages-account-settings-billing.js"></script>
    <script src="<?= base_url('assets/'); ?>js/app-invoice-list.js"></script>
