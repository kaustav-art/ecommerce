...
<html
  ...
  <head>
    ...
    <title>Demo: Property Listing - Wizard Examples | Materialize - Bootstrap Dashboard PRO</title>
  ...
  <body>
                      ...
                      <div class="row g-5">
                        <div class="col-sm-6">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text" id="pl-expeacted-price"
                              ><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i
                            ></span>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text" id="pl-price-sqft"
                              ><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i
                            ></span>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text" id="pl-mentenence-charge"
                              ><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i
                            ></span>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text" id="pl-booking-amount"
                              ><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i
                            ></span>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text" id="pl-other-amount"
                              ><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i
                            ></span>
                          </div>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-between mt-6">
                          ...
                          <button class="btn btn-success btn-submit btn-next">
                            ...
                            <i class="icon-base ri ri-check-line icon-16px ms-0 ms-sm-2"></i>
                          </button>
                        </div>
                      </div>
                    </div>
    ...
    <script src="<?= base_url('assets/'); ?>js/wizard-ex-property-listing.js"></script>
  </body>
</html>
