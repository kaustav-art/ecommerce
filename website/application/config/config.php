...
if (php_sapi_name() === 'cli' || empty($_SERVER['HTTP_HOST'])) {
    $config['base_url'] = 'http://localhost/ecommerce/website/';
} else {
...
|
*/
$config['encryption_key'] = 'website_ecom_secret_key_9948211_!@#';
...
$config['csrf_exclude_uris'] = array('payment/webhook', 'payment/webhook/.*', 'payment/payu_return', 'payment/payu_return/.*', 'payment/failure', 'payment/failure/.*');
