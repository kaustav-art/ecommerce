        ...
        <section class="py-5 bg-light min-vh-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="card border rounded-3 shadow-sm p-4 p-md-5 bg-white mb-4">
                            <!-- Success Header -->
                            <div class="text-center mb-4">
                                <div class="rounded-circle bg-success text-white d-inline-flex align-items-center justify-content-center mb-3 shadow" style="width: 72px; height: 72px;">
                                    <i class="fa-solid fa-check fs-2"></i>
                                </div>
                                <h3 class="fw-bold mb-1 text-dark">Order Placed Successfully!</h3>
                            ...
                            <div class="card bg-light border rounded-3 p-3 mb-4">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="rounded-circle bg-white p-2 text-success shadow-sm">
                                    ...
                                    <?php if (!empty($order['items'])): ?>
                                        ...
                                        ?>
                                            <div class="list-group-item p-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?= $item_img; ?>" alt="<?= html_escape($item['product_title']); ?>" class="rounded border object-fit-cover" style="width: 56px; height: 56px;" onerror="this.src='<?= base_url('assets/images/products/womens/women-1.jpg'); ?>'">
                                                    <div>
                                                        <div class="fw-bold text-dark mb-1"><?= html_escape($item['product_title']); ?></div>
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-3 pt-2">
                                <a href="<?= site_url('order/track?order_number=' . $order['order_number'] . '&email=' . urlencode($order['customer_email'])); ?>" class="btn btn-outline-primary px-4 py-2 fw-semibold">
                                    <i class="fa-solid fa-truck-fast me-1"></i> Track Order
                                </a>
                                <a href="<?= site_url('shop'); ?>" class="btn btn-primary px-4 py-2 fw-semibold">
