            ...
            <div class="container">
                <div class="tf-topbar_wrap d-flex align-items-center justify-content-center justify-content-xl-between">
                    <ul class="topbar-left d-none d-md-flex align-items-center gap-3">
                        ...
                        <li><a class="text-caption-1 text-white" href="mailto:<?= html_escape($store_settings['site_email'] ?? ''); ?>"><i class="fa-solid fa-envelope me-1 small"></i> <?= html_escape($store_settings['site_email'] ?? 'support@example.com'); ?></a></li>
